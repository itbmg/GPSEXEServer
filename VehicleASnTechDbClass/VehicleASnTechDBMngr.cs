...
namespace VehicleASnTechDbClass
{
    public class VehicleASnTechDBMngr
    {
        ...
        public static void InitializeDB()
        {
            lock (locobj)
            {
                ...
                //conn.ConnectionString = @"Data Source=localhost\SQLEXPRESS;Initial Catalog=vehicle_tracking;User ID=asntech;Password=9849992010";
        ...
        public static DataSet SelectDataSetQuery(string table, string feildstogetdata)
        {
            lock (locobj)
            {
                try
